	...
	<div class="container-fluid all">
		...
		<div class="maincontent row form-horizontal">
			...
			<div class="col-sm-12">
				<div id="main">
					<div id="top">
						<div id="top-txt" class="input-group ">
							<textarea class="form-control " placeholder="发表动态"></textarea>
							<span class="input-group-addon"> <a data-id=""
								href="javascript:;"><i class="glyphicon glyphicon-camera"></i></a>
							</span>
						</div>
						...
						<div class="center-itemlist">
							<c:forEach items="${view.getDynamicModelslist()}" var="item">
								<div class="center-item">
											...
											<div class="center-item-commentitem">
												<div class="center-item-commentitem-main">
													<div class="center-item-commentitem-main-userinfo-img">
														<img
															src="${commentmap.key.getUserinfoByUserRecId().getImage()}" />
													</div>
									...
									<div class="center-item-btn">
										<a href="javascript:;"
											data-dynamicid="${item.getDynamicinfo().getDynamicId()}">
											评论</a>
									</div>
								</div>
